    ...
    {/* <div className="container"> */}
        <div className="row m-0">
            <div className="p-0 col-xl-4 col-lg-3 order-lg-0 order-1 d-flex align-items-center justify-content-center" >
                <img src={process.env.PUBLIC_URL + '/media/img/building.svg'} className="" alt=""/>
            </div>
            <div className="col-lg-5 px-xl-18 col-lg-5 order-lg-1 order-0" >
                <h1>COMPANIES</h1>
                <h2>Choose how, where and when you recruit. Hiring is now automated and decentralised. No more 'low funds' match with matched investment to support operations and scalability.</h2>
                <ul>
